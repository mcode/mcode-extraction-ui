...
function defaultConstructorArgsMetadata(constructorArgs) {
  return [
    ...
    },
    {
      ...
      key: 'mask',
      options: {
        genderAndSex: (constructorArgs.mask && constructorArgs.mask.includes("genderAndSex")),
        mrn: (constructorArgs.mask && constructorArgs.mask.includes("mrn")),
        name: (constructorArgs.mask && constructorArgs.mask.includes("name")),
        address: (constructorArgs.mask && constructorArgs.mask.includes("address")),
        birthDate: (constructorArgs.mask && constructorArgs.mask.includes("birthDate")),
        language: (constructorArgs.mask && constructorArgs.mask.includes("language")),
        ethnicity: (constructorArgs.mask && constructorArgs.mask.includes("ethnicity")),
        race: (constructorArgs.mask && constructorArgs.mask.includes("race")),
        telecom: (constructorArgs.mask && constructorArgs.mask.includes("telecom")),
        multipleBirth: (constructorArgs.mask && constructorArgs.mask.includes("multipleBirth")),
        photo: (constructorArgs.mask && constructorArgs.mask.includes("photo")),
        contact: (constructorArgs.mask && constructorArgs.mask.includes("contact")),
        generalPractitioner: (constructorArgs.mask && constructorArgs.mask.includes("generalPractitioner")),
        managingOrganization: (constructorArgs.mask && constructorArgs.mask.includes("managingOrganization")),
        link: (constructorArgs.mask && constructorArgs.mask.includes("link")),
      },
